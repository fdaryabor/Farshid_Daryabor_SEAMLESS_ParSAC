...
if args.output is None:
    args.output = '/g100_work/tra21_seamless/RESULTS_OBSERVABILITY/ERGOM/output_plots/L4/NOV/' + 'observability_%s%s.png' % (args.variable, '' if args.depth is None else '_%sm' % args.depth)
