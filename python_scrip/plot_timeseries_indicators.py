...
def argument():
    ...
    parser.add_argument(   '--site', '-s',
                                type = str,
                                required = True,
                                help = ''' name of the site (e.g. BATS, L4, Arkona) '''
...
infile = MODEL + '_' + SITE + '_ONEYEAR_INDICATORS.txt'
...
DICTind = {
    ...
    'Arkona':  ['non-living_particulate_organic_carbon',
          'trophic_efficiency',
          'net_primary_production',
          'pH',
          'O2',
